...
class PlayersPage extends React.Component {
    ...
    handlePotentialChange(value) {
        // parse value and update state variables.
            ...
            <div>
                ...
                <Form style={{ width: '80vw', margin: '0 auto', marginTop: '5vh' }}>
                    ...
                    <Row>
                        ...
                        {/* Create a column with a label and slider in a FormGroup item for filtering by Potential.  */}
                        <Col flex={2}><FormGroup style={{ width: '20vw', margin: '0 auto' }}>
                    ...
                    <Card style={{marginTop: '2vh'}}>
                        <CardBody>
                            ...
                            <h6>Rating</h6>
                                ...
                                <Col  push={2} flex={2}>
                                {/* In case the player is a GK, show a radar chart  */}
